...
//    { "olist", "olist", POS_DEAD, do_oasis_list, ADMLVL_BUILDER, SCMD_OASIS_OLIST},
    { "olist", "olist", POS_DEAD, do_olist, ADMLVL_BUILDER, 0},
...
//    { "zlist", "zlist", POS_DEAD, do_oasis_list, ADMLVL_BUILDER, SCMD_OASIS_ZLIST},
    { "zlist", "zlist", POS_DEAD, do_zlist, ADMLVL_BUILDER, 0},
...
void command_interpreter(struct char_data *ch, char *argument) {
    ...
    else if (IS_NPC(ch) && complete_cmd_info[cmd].minimum_level >= ADMLVL_IMMORT)
